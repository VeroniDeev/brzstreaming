      ...
      <div className="slide1 flex items-end w-full h-full " ref={backgroundRef}>
        <div className="info-part w-2/6 h-3/6 flex justify-center ">
          ...
          <div className="description flex flex-col justify-center items-center">
            <h3 className="text-white 2xl:text-xl font-semibold text-center">
              Breaking bad is online !
            </h3>
            <p className="text-white 2xl:text-sm font-semibold text-center 2xl:w-2/5">
              Breaking Bad with 25000 online yes you are not good
            </p>
          </div>
          <div className="all-button flex justify-evenly w-full ">
            <div className="button-play bg-white w-2/5 h-1/3 cursor-pointer rounded-full flex justify-evenly items-center">
              <Image
                src={playButton}
                alt="oui"
                className="button-play w-4 h-4 "
              />
              <p className="2xl:text-base font-semibold">Watch Now</p>
            </div>
            <div className="button-play border-2 w-2/5 h-1/3 rounded-full flex justify-center items-center cursor-pointer">
              <p className="2xl:w-auto text-white text-base font-semibold">
                More Info
              </p>
            </div>
          </div>
